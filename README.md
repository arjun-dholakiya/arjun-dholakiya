# Hi, I'm Arjun Dholakiya
**Full-Stack Developer (MERN & Spring Boot) || Web Developer  || Problem Solver**

📩 Email me **arjundholakiyav@gmail.com** for collaboration, projects, or opportunities.

---

## 🚀 About Me
I’m a **Full-Stack Developer** with hands-on experience in **MERN Stack (MongoDB, Express.js, React.js, Node.js)** and **Spring Boot–based backend development**.  I enjoy building **scalable web applications**, learning **DSA**, and improving my **problem-solving skills**.

---

## 🔭 Currently Working On
- Full-stack web applications using **MERN Stack**
- Backend development with **Node.js, Spring boot & REST APIs**
- Improving **Data Structures & Algorithms (DSA)** for technical interviews

---

## 🌱 Currently Learning
- Advanced **React.js patterns and performance optimization**
- **Node.js backend architecture & scalable APIs**
...
- Advanced DSA problem-solving strategies  
